...
public class T3_lifeCycle extends HttpServlet {
	...
	public void init() throws ServletException {
		System.out.println("이곳은 init메소드입니다.");
	}
	
	@Override
	public void destroy() {
		System.out.println("이곳은 destroy메소드입니다.");
	}
	
	@PostConstruct
	public void initPostConstruct() {
		System.out.println("이곳은 init메소드보다 먼저 수행합니다.");
		
	}
	
	@PreDestroy
	public void initPreDestroy() {
		System.out.println("이곳은 destroy메소드보다 나중에 수행합니다.");
