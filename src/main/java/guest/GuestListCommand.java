...
public class GuestListCommand implements GuestInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//2. 한페이지의 분량을 구해준다. (여기서는 1페이지당 5건의 자료를 출력한다고 가정..)
		int pageSize = 5;
		...
		//8. 현재 페이지가 속한 블록의 번호를 구한다.
		int curBlock = (pag - 1) / blockSize; // (1page, 2page, 3page는 0블록), (4page, 5page는 1블록)
		...
		request.setAttribute("pagSize", pageSize);
