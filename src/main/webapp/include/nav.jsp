...
<script>
  ...
  function memberDeleteCheck() {
	  ...
	  if(ans) {
		  ans = confirm("회원에 탈퇴하시면 같은 아이디로 1개월동안 사용하실 수 없습니다.\n그래도 탈퇴하시겠습니까?");
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link active" href="http://192.168.50.59:9090/springGreen/Main">HOME</a>
      </li>
      <li class="nav-item">
		      ...
		      <li>
			      <div class="dropdown me-2">
					    ...
					    <ul class="dropdown-menu">
					      ...
					      <li><a class="dropdown-item" href="_____.do">확장자 패턴</a></li>
					      <li><a class="dropdown-item" href="DbTest.db">데이터베이스 연습</a></li>
					      <li><a class="dropdown-item" href="Password.st">비밀번호 연습</a></li>
					      <li><a class="dropdown-item" href="AjaxForm.st">AJax연습</a></li>
					      <li><a class="dropdown-item" href="AjaxForm2.st">AJax연습2</a></li>
	      ...
	      <li>
		      <div class="dropdown me-2">
				    ...
				    <ul class="dropdown-menu">
				      ...
				      <li><a class="dropdown-item" href="MemberUpdate2.mem">회원정보수정2</a></li>
