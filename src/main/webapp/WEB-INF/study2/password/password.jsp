...
<div class="container">
	...
	<pre>
		* 솔트(salt) *
		암호학에서 salt는 데이터, 비밀번호, 통과하는 암호를 해시처리하기 위한 단방향함수의 추가 키로써 랜덤하게 처리하는 데이터이다.
		...
		<table class="table table-bordered">
			<tr>
				...
				<td colspan="2" class="text-center">
					...
					<input type="button" value="문자비밀번호" onclick="fCheck(2)" class="btn btn-info"/>
					<input type="button" value="SHA암호화1" onclick="fCheck(3)" class="btn btn-primary"/>
