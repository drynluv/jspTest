...
<div class="container">
  ...
  <form name="myform" method="post" action="HoewonUpdateOk.db">
	  <table class="table table-bordered">
	    ...
	    <tr>
	      <th>나이</th>
	      <td><input type="text" name="age" id="age" value="${vo.age}" placeholder="나이를 입력하세요" class="form-control" required/></td>
	    </tr>
	    <tr>
	      <th>성별</th>
	      <td>
	    ...
	    <tr>
	      <td colspan="2" class="text-center">
	        <input type="submit" value="수정하기" onclick="fCheck()" class="btn btn-success"/>
