	...
	<div class="text-center">
		<form name="myform">
			...
			<div class="mb-3">
				...
				<input type="button" value="ajax3" onclick="ajaxCheck3()" class="btn btn-outline-warning" />
				<input type="button" value="ajax4" onclick="ajaxCheck4()" class="btn btn-outline-secondary" />
				<input type="button" value="ajax5" onclick="ajaxCheck5()" class="btn btn-outline-info" />
			</div>
		</form>	
		<hr/>
		<div id="demo"></div>
