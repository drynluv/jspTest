...
<ul class="pagination">
	...
	<c:if test="${pag > 1}">
	<li class="page-item">
		<a class="page-link" href="GuestList.gu?pag=1">«</a>
	</li>
	</c:if>
	...
	<li class="page-item">
		<a class="page-link" href="GuestList.gu?pag=${(curBlock-1)*blockSize+1}">‹</a>
	</li>
	</c:if>
	...
	<c:otherwise>
	<li class="page-item">
		<a class="page-link" href="GuestList.gu?pag=${i}">${i}</a>
	</li>
	</c:otherwise>
	...
	<c:if test="${pag < totPage}">
	<li class="page-item">
		<a class="page-link" href="GuestList.gu?pag=${totPage}">»</a>
	</li>
	</c:if>
