...
<div class="container">
	...
	<fmt:formatNumber value="${won1}" pattern="0,0000,000" /> / <fmt:formatNumber value="${won2}" pattern="0,000,000.0"/><br/>
	<fmt:formatNumber value="${won1}" pattern="0,0000,000" /> / <fmt:formatNumber value="${won2}" pattern="#,###,##0.0"/><br/>
	<br/>
	3.화폐단위<br/>
	원화 : <fmt:formatNumber value="${won1}" type="currency" /><br/>
	US달러1 : <fmt:formatNumber value="${won1}" type="currency" currencyCode="USD" /><br/>
	US달러2 : <fmt:formatNumber value="${won2}" type="currency" currencyCode="USD" pattern="#,##0.00"/><br/>
	<br/>
	4.백분율<br/>
